          ...
          <CardContent>
            <ResponsiveContainer width="100%" height={300}>
              <PieChart>
                ...
                >
                  {insights?.salesByStatus.map((entry: { color: string | undefined; }, index: Key | null | undefined) => (
          ...
          <CardContent>
            <div className="h-[300px] overflow-auto">
              <table className="w-full">
                ...
                <tbody>
                  {insights?.topCustomers.map((customer: { id: Key | null | undefined; name: string ; totalSpent: number; ordersCount: number }) => (
          ...
          <CardContent>
            <div className="h-[300px] overflow-auto">
              <table className="w-full">
                ...
                <tbody>
                  {insights?.surveyMetrics.map((metric: { categoryName: string; avgScore: number; count: number }) => (
